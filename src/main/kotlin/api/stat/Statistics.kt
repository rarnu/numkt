package com.rarnu.numkt.api.stat
...
interface Statistics {
     ...
     */
    fun <T : Number, D : Dimension> average(a: MultiArray<T, D>, weights: MultiArray<T, D>? = null): Double
     ...
     */
    fun <T : Number, D : Dimension, O : Dimension> mean(a: MultiArray<T, D>, axis: Int): NDArray<Double, O>
