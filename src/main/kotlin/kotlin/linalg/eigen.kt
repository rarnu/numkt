...
import com.rarnu.numkt.ndarray.complex.toComplexFloat
 ...
 */
private fun qrShiftedFloat(a: MultiArray<ComplexFloat, D2>, trialsNumber: Int = 30): Pair<D2Array<ComplexFloat>, D2Array<ComplexFloat>> {
    val (n, _) = a.shape
    val z = Numkt.identity<ComplexFloat>(a.shape[0])
    val v = Numkt.zeros<ComplexFloat>(2)
