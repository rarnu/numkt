...
//-------------------dotMM--------------------------
internal fun <T : Number> dotMatrix(a: MultiArray<T, D2>, b: MultiArray<T, D2>): D2Array<T> = dotMatrixCommon(a, b)

internal fun <T : Complex> dotMatrixComplex(a: MultiArray<T, D2>, b: MultiArray<T, D2>): D2Array<T> = dotMatrixCommon(a, b)
...
private fun <T> dotMatrixCommon(a: MultiArray<T, D2>, b: MultiArray<T, D2>): D2Array<T> {
    ...
    when (a.dtype) {
        DataType.FloatDataType -> dotMatrix(a.data.getFloatArray(), a.offset, a.strides, b.data.getFloatArray(), b.offset, b.strides, newShape[0], newShape[1], a.shape[1], ret.data.getFloatArray(), ret.strides[0])
        DataType.IntDataType -> dotMatrix(a.data.getIntArray(), a.offset, a.strides, b.data.getIntArray(), b.offset, b.strides, newShape[0], newShape[1], a.shape[1], ret.data.getIntArray(), ret.strides[0])
        DataType.DoubleDataType -> dotMatrix(a.data.getDoubleArray(), a.offset, a.strides, b.data.getDoubleArray(), b.offset, b.strides, newShape[0], newShape[1], a.shape[1], ret.data.getDoubleArray(), ret.strides[0])
        DataType.LongDataType -> dotMatrix(a.data.getLongArray(), a.offset, a.strides, b.data.getLongArray(), b.offset, b.strides, newShape[0], newShape[1], a.shape[1], ret.data.getLongArray(), ret.strides[0])
        DataType.ComplexDoubleDataType -> dotMatrixComplex(a.data.getComplexDoubleArray(), a.offset, a.strides, b.data.getComplexDoubleArray(), b.offset, b.strides, newShape[0], newShape[1], a.shape[1], ret.data.getComplexDoubleArray(), ret.strides[0])
        DataType.ComplexFloatDataType -> dotMatrixComplex(a.data.getComplexFloatArray(), a.offset, a.strides, b.data.getComplexFloatArray(), b.offset, b.strides, newShape[0], newShape[1], a.shape[1], ret.data.getComplexFloatArray(), ret.strides[0])
        DataType.ShortDataType -> dotMatrix(a.data.getShortArray(), a.offset, a.strides, b.data.getShortArray(), b.offset, b.strides, newShape[0], newShape[1], a.shape[1], ret.data.getShortArray(), ret.strides[0])
        DataType.ByteDataType -> dotMatrix(a.data.getByteArray(), a.offset, a.strides, b.data.getByteArray(), b.offset, b.strides, newShape[0], newShape[1], a.shape[1], ret.data.getByteArray(), ret.strides[0])
    }
    return ret
}

private fun dotMatrix(left: ByteArray, leftOffset: Int, leftStrides: IntArray, right: ByteArray, rightOffset: Int, rightStrides: IntArray, n: Int, m: Int, t: Int, destination: ByteArray, dStrides: Int): ByteArray {
    ...
    for (i in 0 until n) {
        ...
        for (k in 0 until t) {
            ...
            for (j in 0 until m) {
                destination[dInd + j] = (destination[dInd + j] + ceil * right[rInd + j * rightStride1]).toByte()
            }
        }
    }
    return destination
...
private fun dotMatrix(left: ShortArray, leftOffset: Int, leftStrides: IntArray, right: ShortArray, rightOffset: Int, rightStrides: IntArray, n: Int, m: Int, t: Int, destination: ShortArray, dStrides: Int): ShortArray {
    val (leftStride0, leftStride1) = leftStrides
    val (rightStride0, rightStride1) = rightStrides
    ...
    for (i in 0 until n) {
        ...
        for (k in 0 until t) {
            ...
            val rInd = k * rightStride0 + rightOffset
            for (j in 0 until m) {
                destination[dInd + j] = (destination[dInd + j] + ceil * right[rInd + j * rightStride1]).toShort()
            }
        }
    }
    return destination
...
//-------------------dotMV------------------------
internal fun <T : Number> dotMatrixToVector(a: MultiArray<T, D2>, b: MultiArray<T, D1>): D1Array<T> = dotMatrixToVectorCommon(a, b)

internal fun <T : Complex> dotMatrixToVectorComplex(a: MultiArray<T, D2>, b: MultiArray<T, D1>): D1Array<T> = dotMatrixToVectorCommon(a, b)
...
private fun <T> dotMatrixToVectorCommon(a: MultiArray<T, D2>, b: MultiArray<T, D1>): D1Array<T> {
    ...
    when (a.dtype) {
        DataType.FloatDataType -> dotVector(a.data.getFloatArray(), a.offset, a.strides, b.data.getFloatArray(), b.offset, b.strides[0], newShape[0], b.shape[0], ret.data.getFloatArray())
        DataType.IntDataType -> dotVector(a.data.getIntArray(), a.offset, a.strides, b.data.getIntArray(), b.offset, b.strides[0], newShape[0], b.shape[0], ret.data.getIntArray())
        DataType.DoubleDataType -> dotVector(a.data.getDoubleArray(), a.offset, a.strides, b.data.getDoubleArray(), b.offset, b.strides[0], newShape[0], b.shape[0], ret.data.getDoubleArray())
        DataType.LongDataType -> dotVector(a.data.getLongArray(), a.offset, a.strides, b.data.getLongArray(), b.offset, b.strides[0], newShape[0], b.shape[0], ret.data.getLongArray())
        DataType.ComplexDoubleDataType -> dotVectorComplex(a.data.getComplexDoubleArray(), a.offset, a.strides, b.data.getComplexDoubleArray(), b.offset, b.strides[0], newShape[0], b.shape[0], ret.data.getComplexDoubleArray())
        DataType.ComplexFloatDataType -> dotVectorComplex(a.data.getComplexFloatArray(), a.offset, a.strides, b.data.getComplexFloatArray(), b.offset, b.strides[0], newShape[0], b.shape[0], ret.data.getComplexFloatArray())
        DataType.ShortDataType -> dotVector(a.data.getShortArray(), a.offset, a.strides, b.data.getShortArray(), b.offset, b.strides[0], newShape[0], b.shape[0], ret.data.getShortArray())
        DataType.ByteDataType -> dotVector(a.data.getByteArray(), a.offset, a.strides, b.data.getByteArray(), b.offset, b.strides[0], newShape[0], b.shape[0], ret.data.getByteArray())
    }
    return ret
}
...
private fun dotVecToVec(left: FloatArray, leftOffset: Int, lStride: Int, right: FloatArray, rightOffset: Int, rStride: Int, n: Int): Float {
    var ret = 0f
    for (i in 0 until n) {
...
private fun dotVecToVec(left: IntArray, leftOffset: Int, lStride: Int, right: IntArray, rightOffset: Int, rStride: Int, n: Int): Int {
    var ret = 0
    for (i in 0 until n) {
        ret += left[leftOffset + lStride * i] * right[rightOffset + rStride * i]
    }
...
private fun dotVecToVec(left: DoubleArray, leftOffset: Int, lStride: Int, right: DoubleArray, rightOffset: Int, rStride: Int, n: Int): Double {
    var ret = 0.0
    for (i in 0 until n) {
        ret += left[leftOffset + lStride * i] * right[rightOffset + rStride * i]
    }
...
private fun dotVecToVec(left: LongArray, leftOffset: Int, lStride: Int, right: LongArray, rightOffset: Int, rStride: Int, n: Int): Long {
    var ret = 0L
    for (i in 0 until n) {
        ret += left[leftOffset + lStride * i] * right[rightOffset + rStride * i]
    }
...
private fun dotVecToVec(left: ShortArray, leftOffset: Int, lStride: Int, right: ShortArray, rightOffset: Int, rStride: Int, n: Int): Short {
    var ret = 0
    for (i in 0 until n) {
        ret += left[leftOffset + lStride * i] * right[rightOffset + rStride * i]
    }
...
private fun dotVecToVec(left: ByteArray, leftOffset: Int, lStride: Int, right: ByteArray, rightOffset: Int, rStride: Int, n: Int): Byte {
    var ret = 0
    for (i in 0 until n) {
        ret += left[leftOffset + lStride * i] * right[rightOffset + rStride * i]
    }
...
private fun dotVecToVecComplex(left: ComplexFloatArray, leftOffset: Int, lStride: Int, right: ComplexFloatArray, rightOffset: Int, rStride: Int, n: Int): ComplexFloat {
...
private fun dotVecToVecComplex(left: ComplexDoubleArray, leftOffset: Int, lStride: Int, right: ComplexDoubleArray, rightOffset: Int, rStride: Int, n: Int): ComplexDouble {
