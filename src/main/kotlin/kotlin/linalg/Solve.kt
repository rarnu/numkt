...
internal fun solveDouble(a: MultiArray<Double, D2>, b: MultiArray<Double, D2>, singularityErrorLevel: Double = 1e-7): D2Array<Double> {
    ...
    for (i in 0 until U.shape[0]) {
        if (abs(U[i, i]) < singularityErrorLevel) throw ArithmeticException("Matrix a is singular or almost singular")
    }
...
internal fun solveComplexDouble(a: MultiArray<ComplexDouble, D2>, b: MultiArray<ComplexDouble, D2>, singularityErrorLevel: Double = 1e-7): D2Array<ComplexDouble> {
    ...
    for (i in 0 until U.shape[0]) {
        if (U[i, i].abs() < singularityErrorLevel) throw ArithmeticException("Matrix a is singular or almost singular")
    }
...
private fun solveTriangle(a: MultiArray<Double, D2>, b: MultiArray<Double, D2>, isLowerTriangle: Boolean = true): D2Array<Double> = solveTriangleleCommon(a, b.deepCopy() as D2Array<Double>, isLowerTriangle, { cf1, cf2 -> cf1 / cf2 }, { cf1, cf2, cf3, cf4 -> cf1 - (cf2 * cf3 / cf4) })

private fun solveTriangleF(a: MultiArray<Float, D2>, b: MultiArray<Float, D2>, isLowerTriangle: Boolean = true): D2Array<Float> = solveTriangleleCommon(a, b.deepCopy() as D2Array<Float>, isLowerTriangle, { cf1, cf2 -> cf1 / cf2 }, { cf1, cf2, cf3, cf4 -> cf1 - (cf2 * cf3 / cf4) })
...
private fun solveTriangleComplexDouble(a: MultiArray<ComplexDouble, D2>, b: MultiArray<ComplexDouble, D2>, isLowerTriangle: Boolean = true): D2Array<ComplexDouble> =
    solveTriangleleCommon(a, b.deepCopy() as D2Array<ComplexDouble>, isLowerTriangle, { cf1, cf2 -> cf1 / cf2 }, { cf1, cf2, cf3, cf4 -> cf1 - (cf2 * cf3 / cf4) })
...
private fun solveTriangleComplexFloat(a: MultiArray<ComplexFloat, D2>, b: MultiArray<ComplexFloat, D2>, isLowerTriangle: Boolean = true): D2Array<ComplexFloat> =
    solveTriangleleCommon(a, b.deepCopy() as D2Array<ComplexFloat>, isLowerTriangle, { cf1, cf2 -> cf1 / cf2 }, { cf1, cf2, cf3, cf4 -> cf1 - (cf2 * cf3 / cf4) })
 ...
 */
private inline fun <T> solveTriangleleCommon(a: MultiArray<T, D2>, x: D2Array<T>, isLowerTriangle: Boolean = true, actionFirst: (T, T) -> T, actionSecond: (T, T, T, T) -> T): D2Array<T> {
