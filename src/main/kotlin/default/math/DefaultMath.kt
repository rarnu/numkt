...
object DefaultMath : Math {
    ...
    override val mathEx: MathEx get() = DefaultMathEx
    ...
    override fun <T : Number, D : Dimension, O : Dimension> argMax(a: MultiArray<T, D>, axis: Int): NDArray<Int, O> = ktMath.argMax(a, axis)
    ...
    override fun <T : Number, D : Dimension, O : Dimension> argMin(a: MultiArray<T, D>, axis: Int): NDArray<Int, O> = ktMath.argMin(a, axis)
    ...
    override fun <T : Number, D : Dimension, O : Dimension> max(a: MultiArray<T, D>, axis: Int): NDArray<T, O> = ktMath.max(a, axis)
    ...
    override fun <T : Number, D : Dimension, O : Dimension> min(a: MultiArray<T, D>, axis: Int): NDArray<T, O> = ktMath.min(a, axis)
    ...
    override fun <T : Number, D : Dimension, O : Dimension> sum(a: MultiArray<T, D>, axis: Int): NDArray<T, O> = ktMath.sum(a, axis)
    ...
    override fun <T : Number, D : Dimension> cumSum(a: MultiArray<T, D>): D1Array<T> = natMath.cumSum(a)

    override fun <T : Number, D : Dimension> cumSum(a: MultiArray<T, D>, axis: Int): NDArray<T, D> = ktMath.cumSum(a, axis)
}