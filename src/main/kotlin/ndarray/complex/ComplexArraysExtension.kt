...
import com.rarnu.numkt.ndarray.operations.mapCapacity
 ...
 */
fun complexFloatArrayOf(vararg elements: ComplexFloat): ComplexFloatArray = if (elements.isEmpty()) ComplexFloatArray(0) else ComplexFloatArray(elements.size) { elements[it] }

fun complexDoubleArrayOf(vararg elements: ComplexDouble): ComplexDoubleArray = if (elements.isEmpty()) ComplexDoubleArray(0) else ComplexDoubleArray(elements.size) { elements[it] }
 ...
 */
inline operator fun ComplexFloatArray.component1(): ComplexFloat = get(0)
 ...
 * If the size of this array is less than 1, throws an [IndexOutOfBoundsException].
 */
inline operator fun ComplexDoubleArray.component1(): ComplexDouble = get(0)
...
inline operator fun ComplexFloatArray.component2(): ComplexFloat = get(1)
...
inline operator fun ComplexDoubleArray.component2(): ComplexDouble = get(1)
...
inline operator fun ComplexFloatArray.component3(): ComplexFloat = get(2)
 ...
 * If the size of this array is less than 3, throws an [IndexOutOfBoundsException].
 */
inline operator fun ComplexDoubleArray.component3(): ComplexDouble = get(2)
 ...
 */
inline operator fun ComplexFloatArray.component4(): ComplexFloat = get(3)
 ...
 * If the size of this array is less than 4, throws an [IndexOutOfBoundsException].
 */
inline operator fun ComplexDoubleArray.component4(): ComplexDouble = get(3)
 ...
 */
inline operator fun ComplexFloatArray.component5(): ComplexFloat = get(4)
 ...
 * If the size of this array is less than 5, throws an [IndexOutOfBoundsException].
 */
inline operator fun ComplexDoubleArray.component5(): ComplexDouble = get(4)

/**
 * Returns `true` if [element] is found in the array.
 */
operator fun ComplexFloatArray.contains(element: ComplexFloat): Boolean = indexOf(element) >= 0

/**
 * Returns `true` if [element] is found in the array.
 */
operator fun ComplexDoubleArray.contains(element: ComplexDouble): Boolean = indexOf(element) >= 0

/**
 * Returns an element at the given [index] or throws an [IndexOutOfBoundsException] if the [index] is out of bounds of this array.
 */
fun ComplexFloatArray.elementAt(index: Int): ComplexFloat = get(index)

/**
 * Returns an element at the given [index] or throws an [IndexOutOfBoundsException] if the [index] is out of bounds of this array.
 */
fun ComplexDoubleArray.elementAt(index: Int): ComplexDouble = get(index)

/**
 * Returns an element at the given [index] or the result of calling the [defaultValue] function if the [index] is out of bounds of this array.
 */
inline fun ComplexFloatArray.elementAtOrElse(index: Int, defaultValue: (Int) -> ComplexFloat): ComplexFloat = if (index in 0..lastIndex) get(index) else defaultValue(index)

/**
 * Returns an element at the given [index] or the result of calling the [defaultValue] function if the [index] is out of bounds of this array.
 */
inline fun ComplexDoubleArray.elementAtOrElse(index: Int, defaultValue: (Int) -> ComplexDouble): ComplexDouble = if (index in 0..lastIndex) get(index) else defaultValue(index)

/**
 * Returns an element at the given [index] or `null` if the [index] is out of bounds of this array.
 */
inline fun ComplexFloatArray.elementAtOrNull(index: Int): ComplexFloat? = this.getOrNull(index)

/**
 * Returns an element at the given [index] or `null` if the [index] is out of bounds of this array.
 */
inline fun ComplexDoubleArray.elementAtOrNull(index: Int): ComplexDouble? = this.getOrNull(index)

/**
 * Returns the first element matching the given [predicate], or `null` if no such element was found.
 */
inline fun ComplexFloatArray.find(predicate: (ComplexFloat) -> Boolean): ComplexFloat? = firstOrNull(predicate)

/**
 * Returns the first element matching the given [predicate], or `null` if no such element was found.
 */
inline fun ComplexDoubleArray.find(predicate: (ComplexDouble) -> Boolean): ComplexDouble? = firstOrNull(predicate)

/**
 * Returns the last element matching the given [predicate], or `null` if no such element was found.
 */
inline fun ComplexFloatArray.findLast(predicate: (ComplexFloat) -> Boolean): ComplexFloat? = lastOrNull(predicate)

/**
 * Returns the last element matching the given [predicate], or `null` if no such element was found.
 */
inline fun ComplexDoubleArray.findLast(predicate: (ComplexDouble) -> Boolean): ComplexDouble? = lastOrNull(predicate)

/**
 * Returns first element.
 * @throws [NoSuchElementException] if the array is empty.
 */
fun ComplexFloatArray.first(): ComplexFloat = if (isEmpty()) throw NoSuchElementException("Array is empty.") else this[0]

/**
 * Returns first element.
 * @throws [NoSuchElementException] if the array is empty.
 */
fun ComplexDoubleArray.first(): ComplexDouble = if (isEmpty()) throw NoSuchElementException("Array is empty.") else this[0]
 ...
 */
fun ComplexFloatArray.firstOrNull(): ComplexFloat? = if (isEmpty()) null else this[0]

/**
 * Returns the first element, or `null` if the array is empty.
 */
fun ComplexDoubleArray.firstOrNull(): ComplexDouble? = if (isEmpty()) null else this[0]
 ...
 * Returns an element at the given [index] or the result of calling the [defaultValue] function if the [index] is out of bounds of this array.
 */
inline fun ComplexFloatArray.getOrElse(index: Int, defaultValue: (Int) -> ComplexFloat): ComplexFloat = if (index in 0..lastIndex) get(index) else defaultValue(index)

/**
 * Returns an element at the given [index] or the result of calling the [defaultValue] function if the [index] is out of bounds of this array.
 */
inline fun ComplexDoubleArray.getOrElse(index: Int, defaultValue: (Int) -> ComplexDouble): ComplexDouble = if (index in 0..lastIndex) get(index) else defaultValue(index)

/**
 * Returns an element at the given [index] or `null` if the [index] is out of bounds of this array.
 */
fun ComplexFloatArray.getOrNull(index: Int): ComplexFloat? = if (index in 0..lastIndex) get(index) else null

/**
 * Returns an element at the given [index] or `null` if the [index] is out of bounds of this array.
 */
fun ComplexDoubleArray.getOrNull(index: Int): ComplexDouble? = if (index in 0..lastIndex) get(index) else null
...
fun ComplexFloatArray.lastOrNull(): ComplexFloat? = if (isEmpty()) null else this[size - 1]


/** Returns the last element, or `null` if the array is empty. */
fun ComplexDoubleArray.lastOrNull(): ComplexDouble? = if (isEmpty()) null else this[size - 1]
 ...
 */
inline fun ComplexFloatArray.random(): ComplexFloat = random(Random)
 ...
 * @throws NoSuchElementException if this array is empty.
 */
inline fun ComplexDoubleArray.random(): ComplexDouble = random(Random)
 ...
 * @throws NoSuchElementException if this array is empty.
 */
fun ComplexFloatArray.random(random: Random): ComplexFloat = if (isEmpty()) throw NoSuchElementException("Array is empty.") else get(random.nextInt(size))
 ...
 * @throws NoSuchElementException if this array is empty.
 */
fun ComplexDoubleArray.random(random: Random): ComplexDouble = if (isEmpty()) throw NoSuchElementException("Array is empty.") else get(random.nextInt(size))

/**
 * Returns a random element from this array, or `null` if this array is empty.
 */
inline fun ComplexFloatArray.randomOrNull(): ComplexFloat? = randomOrNull(Random)

/**
 * Returns a random element from this array, or `null` if this array is empty.
 */
inline fun ComplexDoubleArray.randomOrNull(): ComplexDouble? = randomOrNull(Random)

/**
 * Returns a random element from this array using the specified source of randomness, or `null` if this array is empty.
 */
fun ComplexFloatArray.randomOrNull(random: Random): ComplexFloat? = if (isEmpty()) null else get(random.nextInt(size))

/**
 * Returns a random element from this array using the specified source of randomness, or `null` if this array is empty.
 */
fun ComplexDoubleArray.randomOrNull(random: Random): ComplexDouble? = if (isEmpty()) null else get(random.nextInt(size))

/**
 * Returns the single element, or throws an exception if the array is empty or has more than one element.
 */
fun ComplexFloatArray.single(): ComplexFloat = when (size) {
 ...
 * Returns the single element, or throws an exception if the array is empty or has more than one element.
 */
fun ComplexDoubleArray.single(): ComplexDouble = when (size) {
    0 -> throw NoSuchElementException("Array is empty.")
    1 -> this[0]
    else -> throw IllegalArgumentException("Array has more than one element.")
}
 ...
 */
fun ComplexFloatArray.singleOrNull(): ComplexFloat? = if (size == 1) this[0] else null

/**
 * Returns single element, or `null` if the array is empty or has more than one element.
 */
fun ComplexDoubleArray.singleOrNull(): ComplexDouble? = if (size == 1) this[0] else null
...
inline fun ComplexFloatArray.dropLastWhile(predicate: (ComplexFloat) -> Boolean): List<ComplexFloat> {
    for (index in lastIndex downTo 0) {
        if (!predicate(this[index])) return take(index + 1)
    }
    return emptyList()
}
 ...
 */
inline fun ComplexFloatArray.filter(predicate: (ComplexFloat) -> Boolean): List<ComplexFloat> = filterTo(ArrayList(), predicate)

/**
 * Returns a list containing only elements matching the given [predicate].
 */
inline fun ComplexDoubleArray.filter(predicate: (ComplexDouble) -> Boolean): List<ComplexDouble> = filterTo(ArrayList(), predicate)
 ...
 */
inline fun ComplexFloatArray.filterIndexed(predicate: (index: Int, ComplexFloat) -> Boolean): List<ComplexFloat> = filterIndexedTo(ArrayList(), predicate)
 ...
 * and returns the result of predicate evaluation on the element.
 */
inline fun ComplexDoubleArray.filterIndexed(predicate: (index: Int, ComplexDouble) -> Boolean): List<ComplexDouble> = filterIndexedTo(ArrayList(), predicate)
 ...
 */
inline fun ComplexFloatArray.filterNot(predicate: (ComplexFloat) -> Boolean): List<ComplexFloat> = filterNotTo(ArrayList(), predicate)

/**
 * Returns a list containing all elements not matching the given [predicate].
 */
inline fun ComplexDoubleArray.filterNot(predicate: (ComplexDouble) -> Boolean): List<ComplexDouble> = filterNotTo(ArrayList(), predicate)
 ...
 */
fun ComplexFloatArray.sliceArray(indices: IntRange): ComplexFloatArray = if (indices.isEmpty()) ComplexFloatArray(0) else copyOfRange(indices.first, indices.last + 1)

/**
 * Returns an array containing elements at indices in the specified [indices] range.
 */
fun ComplexDoubleArray.sliceArray(indices: IntRange): ComplexDoubleArray = if (indices.isEmpty()) ComplexDoubleArray(0) else copyOfRange(indices.first, indices.last + 1)
 ...
 */
inline fun <R : Comparable<R>> ComplexFloatArray.sortedBy(crossinline selector: (ComplexFloat) -> R?): List<ComplexFloat> = sortedWith(compareBy(selector))


/**
 * Returns a list of all elements sorted according to natural sort order of the value returned by specified [selector] function.
 */
inline fun <R : Comparable<R>> ComplexDoubleArray.sortedBy(crossinline selector: (ComplexDouble) -> R?): List<ComplexDouble> = sortedWith(compareBy(selector))


/**
 * Returns a list of all elements sorted descending according to natural sort order of the value returned by specified [selector] function.
 */
inline fun <R : Comparable<R>> ComplexFloatArray.sortedByDescending(crossinline selector: (ComplexFloat) -> R?): List<ComplexFloat> = sortedWith(compareByDescending(selector))


/**
 * Returns a list of all elements sorted descending according to natural sort order of the value returned by specified [selector] function.
 */
inline fun <R : Comparable<R>> ComplexDoubleArray.sortedByDescending(crossinline selector: (ComplexDouble) -> R?): List<ComplexDouble> = sortedWith(compareByDescending(selector))


/**
 * Returns a list of all elements sorted according to the specified [comparator].
 */
fun ComplexFloatArray.sortedWith(comparator: Comparator<in ComplexFloat>): List<ComplexFloat> = toTypedArray().apply { sortWith(comparator) }.asList()


/**
 * Returns a list of all elements sorted according to the specified [comparator].
 */
fun ComplexDoubleArray.sortedWith(comparator: Comparator<in ComplexDouble>): List<ComplexDouble> = toTypedArray().apply { sortWith(comparator) }.asList()


/**
 * Returns a [List] that wraps the original array.
 */
fun ComplexFloatArray.asList(): List<ComplexFloat> = object : AbstractList<ComplexFloat>(), RandomAccess {
    override val size: Int get() = this@asList.size
    override fun isEmpty(): Boolean = this@asList.isEmpty()
    override fun contains(element: ComplexFloat): Boolean = this@asList.contains(element)
    override fun get(index: Int): ComplexFloat = this@asList[index]
    override fun indexOf(element: ComplexFloat): Int = this@asList.indexOf(element)
    override fun lastIndexOf(element: ComplexFloat): Int = this@asList.lastIndexOf(element)
}

/**
 * Returns a [List] that wraps the original array.
 */
fun ComplexDoubleArray.asList(): List<ComplexDouble> = object : AbstractList<ComplexDouble>(), RandomAccess {
    override val size: Int get() = this@asList.size
    override fun isEmpty(): Boolean = this@asList.isEmpty()
    override fun contains(element: ComplexDouble): Boolean = this@asList.contains(element)
    override fun get(index: Int): ComplexDouble = this@asList[index]
    override fun indexOf(element: ComplexDouble): Int = this@asList.indexOf(element)
    override fun lastIndexOf(element: ComplexDouble): Int = this@asList.lastIndexOf(element)
}
 ...
 */
infix fun ComplexFloatArray?.contentEquals(other: ComplexFloatArray?): Boolean = this?.getFlatArray() contentEquals other?.getFlatArray()
 ...
 * The elements are compared for equality with the [equals][Any.equals] function.
 */
infix fun ComplexDoubleArray?.contentEquals(other: ComplexDoubleArray?): Boolean = this?.getFlatArray() contentEquals other?.getFlatArray()

/**
 * Returns a hash code based on the contents of this array as if it is [List].
 */
fun ComplexFloatArray?.contentHashCode(): Int = this?.getFlatArray().contentHashCode()

/**
 * Returns a hash code based on the contents of this array as if it is [List].
 */
fun ComplexDoubleArray?.contentHashCode(): Int = this?.getFlatArray().contentHashCode()
 ...
 */
val ComplexFloatArray.indices: IntRange get() = IntRange(0, lastIndex)

/**
 * Returns the range of valid indices for the array.
 */
val ComplexDoubleArray.indices: IntRange get() = IntRange(0, lastIndex)

/**
 * Returns `true` if the array is empty.
 */
inline fun ComplexFloatArray.isEmpty(): Boolean = size == 0

/**
 * Returns `true` if the array is empty.
 */
inline fun ComplexDoubleArray.isEmpty(): Boolean = size == 0

/**
 * Returns `true` if the array is not empty.
 */
inline fun ComplexFloatArray.isNotEmpty(): Boolean = !isEmpty()

/**
 * Returns `true` if the array is not empty.
 */
inline fun ComplexDoubleArray.isNotEmpty(): Boolean = !isEmpty()

/**
 * Returns the last valid index for the array.
 */
val ComplexFloatArray.lastIndex: Int get() = size - 1

/**
 * Returns the last valid index for the array.
 */
val ComplexDoubleArray.lastIndex: Int get() = size - 1
...
/**
 * Returns an array of ComplexFloat containing all the elements of this generic array.
 */
fun Array<out ComplexFloat>.toComplexFloatArray(): ComplexFloatArray = ComplexFloatArray(size) { index -> this[index] }

/**
 * Returns an array of ComplexDouble containing all the elements of this generic array.
 */
fun Array<out ComplexDouble>.toComplexDoubleArray(): ComplexDoubleArray = ComplexDoubleArray(size) { index -> this[index] }

/**
 * Returns an array of ComplexFloat containing all the elements of this generic array.
 */
fun FloatArray.toComplexFloatArray(): ComplexFloatArray = ComplexFloatArray(size).apply { this@toComplexFloatArray.copyInto(this.getFlatArray()) }

/**
 * Returns an array of ComplexDouble containing all the elements of this generic array.
 */
fun DoubleArray.toComplexDoubleArray(): ComplexDoubleArray = ComplexDoubleArray(size).apply { this@toComplexDoubleArray.copyInto(this.getFlatArray()) }

/**
 * Returns an array of ComplexFloat containing all the elements of this collection.
 */
fun Collection<ComplexFloat>.toComplexFloatArray(): ComplexFloatArray {
    val result = ComplexFloatArray(size)
    var index = 0
    for (element in this) {
        result[index++] = element
 ...
 * Returns an array of ComplexDouble containing all the elements of this generic array.
 */
fun Collection<ComplexDouble>.toComplexDoubleArray(): ComplexDoubleArray {
    val result = ComplexDoubleArray(size)
    var index = 0
    for (element in this) {
        result[index++] = element
 ...
 *
 * If any two elements should have the same key returned by [keySelector] the last one gets added to the map.
 *
 * The returned map preserves the entry iteration order of the original array.
 */
 ...
 * value is provided by the [valueTransform] function applied to elements of the given array.
 *
 * If any two elements should have the same key returned by [keySelector] the last one gets added to the map.
 */
 ...
 */
fun ComplexFloatArray.toHashSet(): HashSet<ComplexFloat> = toCollection(HashSet(mapCapacity(size)))


/**
 * Returns a new [HashSet] of all elements.
 */
fun ComplexDoubleArray.toHashSet(): HashSet<ComplexDouble> = toCollection(HashSet(mapCapacity(size)))


/**
 * Returns a [List] containing all elements.
 */
fun ComplexFloatArray.toList(): List<ComplexFloat> = when (size) {
    0 -> emptyList()
    1 -> listOf(this[0])
 ...
 * Returns a [List] containing all elements.
 */
fun ComplexDoubleArray.toList(): List<ComplexDouble> = when (size) {
    0 -> emptyList()
    1 -> listOf(this[0])
    else -> this.toMutableList()
}
 ...
 */
fun ComplexFloatArray.toSet(): Set<ComplexFloat> = when (size) {
    0 -> emptySet()
    1 -> setOf(this[0])
 ...
 * The returned set preserves the element iteration order of the original array.
 */
fun ComplexDoubleArray.toSet(): Set<ComplexDouble> = when (size) {
    0 -> emptySet()
    1 -> setOf(this[0])
    else -> toCollection(LinkedHashSet(mapCapacity(size)))
}
 ...
 */
inline fun <R> ComplexFloatArray.flatMap(transform: (ComplexFloat) -> Iterable<R>): List<R> = flatMapTo(ArrayList(), transform)


/**
 * Returns a single list of all elements yielded from results of [transform] function being invoked on each element of original array.
 */
inline fun <R> ComplexDoubleArray.flatMap(transform: (ComplexDouble) -> Iterable<R>): List<R> = flatMapTo(ArrayList(), transform)
 ...
 */
inline fun <R> ComplexFloatArray.flatMapIndexed(transform: (index: Int, ComplexFloat) -> Iterable<R>): List<R> = flatMapIndexedTo(ArrayList(), transform)

/**
 * Returns a single list of all elements yielded from results of [transform] function being invoked on each element
 * and its index in the original array.
 */
inline fun <R> ComplexDoubleArray.flatMapIndexed(transform: (index: Int, ComplexDouble) -> Iterable<R>): List<R> = flatMapIndexedTo(ArrayList(), transform)
 ...
 */
inline fun <K> ComplexFloatArray.groupBy(keySelector: (ComplexFloat) -> K): Map<K, List<ComplexFloat>> = groupByTo(LinkedHashMap(), keySelector)
 ...
 * The returned map preserves the entry iteration order of the keys produced from the original array.
 */
inline fun <K> ComplexDoubleArray.groupBy(keySelector: (ComplexDouble) -> K): Map<K, List<ComplexDouble>> = groupByTo(LinkedHashMap(), keySelector)
 ...
 * The returned map preserves the entry iteration order of the keys produced from the original array.
 */
inline fun <K, V> ComplexFloatArray.groupBy(keySelector: (ComplexFloat) -> K, valueTransform: (ComplexFloat) -> V): Map<K, List<V>> = groupByTo(LinkedHashMap(), keySelector, valueTransform)
 ...
 * The returned map preserves the entry iteration order of the keys produced from the original array.
 */
inline fun <K, V> ComplexDoubleArray.groupBy(keySelector: (ComplexDouble) -> K, valueTransform: (ComplexDouble) -> V): Map<K, List<V>> = groupByTo(LinkedHashMap(), keySelector, valueTransform)
 ...
 */
inline fun <R> ComplexFloatArray.map(transform: (ComplexFloat) -> R): List<R> = mapTo(ArrayList(size), transform)
 ...
 * to each element in the original array.
 */
inline fun <R> ComplexDoubleArray.map(transform: (ComplexDouble) -> R): List<R> = mapTo(ArrayList(size), transform)
 ...
 */
inline fun <R> ComplexFloatArray.mapIndexed(transform: (index: Int, ComplexFloat) -> R): List<R> = mapIndexedTo(ArrayList(size), transform)
 ...
 * and returns the result of the transform applied to the element.
 */
inline fun <R> ComplexDoubleArray.mapIndexed(transform: (index: Int, ComplexDouble) -> R): List<R> = mapIndexedTo(ArrayList(size), transform)
 ...
 */
fun ComplexFloatArray.withIndex(): Iterable<IndexedValue<ComplexFloat>> = object : Iterable<IndexedValue<ComplexFloat>> {
    override fun iterator(): Iterator<IndexedValue<ComplexFloat>> = object : Iterator<IndexedValue<ComplexFloat>> {
        ...
        override fun next(): IndexedValue<ComplexFloat> = IndexedValue(
            if (index++ < 0) throw ArithmeticException("Index overflow has happened.") else index, iterator.next()
        )
    }
}
 ...
 * into an [IndexedValue] containing the index of that element and the element itself.
 */
fun ComplexDoubleArray.withIndex(): Iterable<IndexedValue<ComplexDouble>> = object : Iterable<IndexedValue<ComplexDouble>> {
    override fun iterator(): Iterator<IndexedValue<ComplexDouble>> = object : Iterator<IndexedValue<ComplexDouble>> {
        private var index = 0
        private val iterator = this@withIndex.iterator()
        override fun hasNext(): Boolean = iterator.hasNext()
        override fun next(): IndexedValue<ComplexDouble> = IndexedValue(
            if (index++ < 0) throw ArithmeticException("Index overflow has happened.") else index, iterator.next()
        )
    }
}
 ...
 */
fun ComplexFloatArray.distinct(): List<ComplexFloat> = this.toMutableSet().toList()
 ...
 * The elements in the resulting list are in the same order as they were in the source array.
 */
fun ComplexDoubleArray.distinct(): List<ComplexDouble> = this.toMutableSet().toList()
 ...
 * The returned set preserves the element iteration order of the original array.
 */
fun ComplexFloatArray.toMutableSet(): MutableSet<ComplexFloat> = toCollection(LinkedHashSet(mapCapacity(size)))
 ...
 * The returned set preserves the element iteration order of the original array.
 */
fun ComplexDoubleArray.toMutableSet(): MutableSet<ComplexDouble> = toCollection(LinkedHashSet(mapCapacity(size)))
 ...
 */
fun ComplexFloatArray.any(): Boolean = !isEmpty()

/**
 * Returns `true` if array has at least one element.
 */
fun ComplexDoubleArray.any(): Boolean = !isEmpty()
 ...
 */
inline fun ComplexFloatArray.count(): Int = size

/**
 * Returns the number of elements in this array.
 */
inline fun ComplexDoubleArray.count(): Int = size
...
inline fun <R : Comparable<R>> ComplexFloatArray.maxBy(selector: (ComplexFloat) -> R): ComplexFloat = maxByOrNull(selector)!!

inline fun <R : Comparable<R>> ComplexDoubleArray.maxBy(selector: (ComplexDouble) -> R): ComplexDouble = maxByOrNull(selector)!!
...
inline fun <R : Comparable<R>> ComplexFloatArray.minBy(selector: (ComplexFloat) -> R): ComplexFloat = minByOrNull(selector)!!

inline fun <R : Comparable<R>> ComplexDoubleArray.minBy(selector: (ComplexDouble) -> R): ComplexDouble = minByOrNull(selector)!!
...
inline fun <R> ComplexFloatArray.minOfWith(comparator: Comparator<in R>, selector: (ComplexFloat) -> R): R {
    ...
    for (i in 1..lastIndex) {
        val v = selector(this[i])
        if (comparator.compare(minValue, v) > 0) minValue = v
    }
    return minValue
}
 ...
 */
fun ComplexFloatArray.none(): Boolean = isEmpty()

/**
 * Returns `true` if the array has no elements.
 */
fun ComplexDoubleArray.none(): Boolean = isEmpty()
...
/**
 * Performs the given [action] on each element and returns the array itself afterward.
 */
inline fun ComplexFloatArray.onEach(action: (ComplexFloat) -> Unit): ComplexFloatArray = apply {
    for (element in this) {
        action(element)
    }
}
 ...
 * Performs the given [action] on each element and returns the array itself afterward.
 */
inline fun ComplexDoubleArray.onEach(action: (ComplexDouble) -> Unit): ComplexDoubleArray = apply {
    for (element in this) {
        action(element)
    }
}
...
/**
 * Performs the given [action] on each element, providing sequential index with the element,
 * and returns the array itself afterward.
 * @param [action] function that takes the index of an element and the element itself
 * and performs the action on the element.
 */
inline fun ComplexFloatArray.onEachIndexed(action: (index: Int, ComplexFloat) -> Unit): ComplexFloatArray = apply { forEachIndexed(action) }
 ...
 * and performs the action on the element.
 */
inline fun ComplexDoubleArray.onEachIndexed(action: (index: Int, ComplexDouble) -> Unit): ComplexDoubleArray = apply { forEachIndexed(action) }
 ...
 * @param [operation] function that takes current accumulator value and an element, and calculates the next accumulator value.
 */
inline fun <R> ComplexFloatArray.scan(initial: R, operation: (acc: R, ComplexFloat) -> R): List<R> = runningFold(initial, operation)
 ...
 * @param [operation] function that takes current accumulator value and an element, and calculates the next accumulator value.
 */
inline fun <R> ComplexDoubleArray.scan(initial: R, operation: (acc: R, ComplexDouble) -> R): List<R> = runningFold(initial, operation)
 ...
 * and the element itself, and calculates the next accumulator value.
 */
inline fun <R> ComplexFloatArray.scanIndexed(initial: R, operation: (index: Int, acc: R, ComplexFloat) -> R): List<R> = runningFoldIndexed(initial, operation)
 ...
 * and the element itself, and calculates the next accumulator value.
 */
inline fun <R> ComplexDoubleArray.scanIndexed(initial: R, operation: (index: Int, acc: R, ComplexDouble) -> R): List<R> = runningFoldIndexed(initial, operation)

/**
 * Splits the original array into pairs of lists,
 ...
 */
infix fun <R> ComplexFloatArray.zip(other: Array<out R>): List<Pair<ComplexFloat, R>> = zip(other) { t1, t2 -> t1 to t2 }

/**
 * Returns a list of pairs built from the elements of `this` array and the [other] array with the same index.
 * The returned list has length of the shortest collection.
 */
infix fun <R> ComplexDoubleArray.zip(other: Array<out R>): List<Pair<ComplexDouble, R>> = zip(other) { t1, t2 -> t1 to t2 }
 ...
 * The returned list has length of the shortest collection.
 */
infix fun <R> ComplexFloatArray.zip(other: Iterable<R>): List<Pair<ComplexFloat, R>> = zip(other) { t1, t2 -> t1 to t2 }

/**
 * Returns a list of pairs built from the elements of `this` collection and [other] array with the same index.
 * The returned list has length of the shortest collection.
 */
infix fun <R> ComplexDoubleArray.zip(other: Iterable<R>): List<Pair<ComplexDouble, R>> = zip(other) { t1, t2 -> t1 to t2 }
 ...
 * The returned list has length of the shortest collection.
 */
infix fun ComplexFloatArray.zip(other: ComplexFloatArray): List<Pair<ComplexFloat, ComplexFloat>> = zip(other) { t1, t2 -> t1 to t2 }

/**
 * Returns a list of pairs built from the elements of `this` array and the [other] array with the same index.
 * The returned list has length of the shortest collection.
 */
infix fun ComplexDoubleArray.zip(other: ComplexDoubleArray): List<Pair<ComplexDouble, ComplexDouble>> = zip(other) { t1, t2 -> t1 to t2 }
