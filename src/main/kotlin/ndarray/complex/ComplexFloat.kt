 ...
 */
class ComplexFloat private constructor(private val number: Long) : Complex {

    /**
     * The real part of the complex number.
     */
    val re: Float get() = Float.fromBits((number shr 32).toInt())

    /**
     * The imaginary part of the complex number.
     */
    val im: Float get() = Float.fromBits(number.toInt())
     ...
     */
    constructor(re: Float, im: Float) : this(Complex.convertComplexFloatToLong(re, im))
     ...
     */
    fun conjugate(): ComplexFloat = ComplexFloat(re, -im)
     ...
     */
    operator fun plus(other: Byte): ComplexFloat = ComplexFloat(re + other, im)
     ...
     * @return a new [ComplexFloat] with the result of the addition.
     */
    operator fun plus(other: Short): ComplexFloat = ComplexFloat(re + other, im)
     ...
     * @return a new [ComplexFloat] with the result of the addition.
     */
    operator fun plus(other: Int): ComplexFloat = ComplexFloat(re + other, im)
     ...
     * @return a new [ComplexFloat] with the result of the addition.
     */
    operator fun plus(other: Long): ComplexFloat = ComplexFloat(re + other, im)
     ...
     * @return a new [ComplexFloat] with the result of the addition.
     */
    operator fun plus(other: Float): ComplexFloat = ComplexFloat(re + other, im)
     ...
     */
    operator fun plus(other: Double): ComplexDouble = ComplexDouble(re + other, im.toDouble())
     ...
     * @return a new [ComplexFloat] with the result of the addition.
     */
    operator fun plus(other: ComplexFloat): ComplexFloat = ComplexFloat(re + other.re, im + other.im)
     ...
     */
    operator fun minus(other: Byte): ComplexFloat = ComplexFloat(re - other, im)
     ...
     * @return a new [ComplexFloat] representing the result of the subtraction operation.
     */
    operator fun minus(other: Short): ComplexFloat = ComplexFloat(re - other, im)
     ...
     * @return a new [ComplexFloat] representing the result of the subtraction operation.
     */
    operator fun minus(other: Int): ComplexFloat = ComplexFloat(re - other, im)
     ...
     * @return a new [ComplexFloat] representing the result of the subtraction operation.
     */
    operator fun minus(other: Long): ComplexFloat = ComplexFloat(re - other, im)
     ...
     * @return a new [ComplexFloat] representing the result of the subtraction operation.
     */
    operator fun minus(other: Float): ComplexFloat = ComplexFloat(re - other, im)
     ...
     */
    operator fun minus(other: Double): ComplexDouble = ComplexDouble(re - other, im.toDouble())
     ...
     * @return A new [ComplexFloat] representing the result of the subtraction operation.
     */
    operator fun minus(other: ComplexFloat): ComplexFloat = ComplexFloat(re - other.re, im - other.im)
     ...
     */
    operator fun times(other: Byte): ComplexFloat = ComplexFloat(re * other, im * other)
     ...
     * @return a new [ComplexFloat] representing the result of the multiplication
     */
    operator fun times(other: Short): ComplexFloat = ComplexFloat(re * other, im * other)
     ...
     * @return a new [ComplexFloat] representing the result of the multiplication
     */
    operator fun times(other: Int): ComplexFloat = ComplexFloat(re * other, im * other)
     ...
     * @return a new [ComplexFloat] representing the result of the multiplication
     */
    operator fun times(other: Long): ComplexFloat = ComplexFloat(re * other, im * other)
     ...
     * @return a new [ComplexFloat] representing the result of the multiplication
     */
    operator fun times(other: Float): ComplexFloat = ComplexFloat(re * other, im * other)
     ...
     * @return a new [ComplexFloat] representing the result of the multiplication
     */
    operator fun times(other: ComplexFloat): ComplexFloat = ComplexFloat(re * other.re - im * other.im, re * other.im + other.re * im)
     ...
     * @return a new [ComplexDouble] representing the result of the multiplication
     */
    operator fun times(other: ComplexDouble): ComplexDouble = ComplexDouble(re * other.re - im * other.im, re * other.im + other.re * im)
     ...
     */
    operator fun div(other: Byte): ComplexFloat = ComplexFloat(re / other, im / other)
     ...
     * @return a new [ComplexFloat] value after division.
     */
    operator fun div(other: Short): ComplexFloat = ComplexFloat(re / other, im / other)
     ...
     * @return a new [ComplexFloat] value after division.
     */
    operator fun div(other: Int): ComplexFloat = ComplexFloat(re / other, im / other)
     ...
     * @return a new [ComplexFloat] value after division.
     */
    operator fun div(other: Long): ComplexFloat = ComplexFloat(re / other, im / other)
     ...
     * @return a new [ComplexFloat] value after division.
     */
    operator fun div(other: Float): ComplexFloat = ComplexFloat(re / other, im / other)
     ...
     * @return a new [ComplexFloat] value after division.
     */
    operator fun div(other: ComplexFloat): ComplexFloat = when {
    ...
    /** Returns this value. */
    operator fun unaryPlus(): ComplexFloat = this

    /** Returns the negative of this value. */
    operator fun unaryMinus(): ComplexFloat = ComplexFloat(-re, -im)
     ...
     */
    operator fun component1(): Float = re
     ...
     */
    operator fun component2(): Float = im
