 ...
 */
sealed interface ComplexDouble : Complex {
    ...
    companion object {
         ...
         */
        operator fun invoke(re: Double, im: Double): ComplexDouble = if (fitsInFloat(re) && fitsInFloat(im)) ComplexDouble32(re, im) else ComplexDouble64(re, im)
         ...
         */
        operator fun invoke(re: Number, im: Number): ComplexDouble = invoke(re.toDouble(), im.toDouble())

        /**
         * Creates a [ComplexDouble] with a zero imaginary value.
         * @param re the real value of the complex number in number format.
         */
        operator fun invoke(re: Number): ComplexDouble = if (fitsInFloat(re.toDouble())) ComplexDouble32(re.toDouble(), 0.0) else ComplexDouble64(re.toDouble(), 0.0)

        /**
         * Represents a [ComplexDouble] number with 1.0 real part and 0f imaginary part.
         */
        val one: ComplexDouble get() = ComplexDouble32(1.0, 0.0)

        /**
         * Represents a [ComplexDouble] number with real and imaginary parts set to 0.0.
         */
        val zero: ComplexDouble get() = ComplexDouble32(0.0, 0.0)

        /**
         * Represents a not-a-number (NaN) value in complex floating point arithmetic.
         */
        val NaN: ComplexDouble get() = ComplexDouble64(Double.NaN, Double.NaN)
    }
     ...
     * @return a new [ComplexDouble] with the result of the addition.
     */
    operator fun plus(other: ComplexFloat): ComplexDouble = ComplexDouble(re + other.re, im + other.im)
     ...
     * @return a new [ComplexDouble] representing the result of the subtraction operation.
     */
    operator fun minus(other: ComplexFloat): ComplexDouble = ComplexDouble(re - other.re, im - other.im)
     ...
     * @return a new [ComplexDouble] representing the result of the multiplication
     */
    operator fun times(other: ComplexFloat): ComplexDouble = ComplexDouble(re * other.re - im * other.im, re * other.im + other.re * im)
     ...
     * @return a new [ComplexDouble] value after division.
     */
    operator fun div(other: ComplexFloat): ComplexDouble = when {
 ...
 */
class ComplexDouble64 internal constructor(override val re: Double, override val im: Double) : ComplexDouble {
 ...
 * @property im the imaginary part of the complex number.
 */
class ComplexDouble32 internal constructor(private val number: Long) : ComplexDouble {

    override val re: Double get() = Float.fromBits((number shr 32).toInt()).toDouble()

    override val im: Double get() = Float.fromBits(number.toInt()).toDouble()
