...
sealed interface Complex {
    companion object {
         ...
         */
        fun r(re: Float): ComplexFloat = ComplexFloat(re, 0f)
         ...
         */
        fun r(re: Double): ComplexDouble = ComplexDouble(re, 0.0)
         ...
         */
        fun i(im: Float): ComplexFloat = ComplexFloat(0f, im)
         ...
         */
        fun i(im: Double): ComplexDouble = ComplexDouble(0.0, im)
         ...
         */
        internal fun convertComplexFloatToLong(re: Float, im: Float): Long = (re.toRawBits().toLong() shl 32) or (im.toRawBits().toLong() and 0xFFFFFFFFL)
    }
}
