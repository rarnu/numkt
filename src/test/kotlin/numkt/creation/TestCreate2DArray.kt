...
class TestCreate2DArray {
    ...
    fun createZeroFilledByteArray() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.zeros<Byte>(dim1, dim2)
    ...
    fun createByteArrayFilledWithOnes() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.ones<Byte>(dim1, dim2)
    ...
    fun createTwoDimensionalArrayFromByteList() {
        ...
        val a: D2Array<Byte> = Numkt.ndarray(list)
    ...
    fun createTwoDimensionalArrayFromByteSet() {
        ...
        val a: D2Array<Byte> = Numkt.ndarray(set, shape = shape)
    ...
    fun createByte2DArrayWithInitializationFunction() {
        val a = Numkt.d2array<Byte>(2, 3) { (it + 3).toByte() }
    ...
    fun createByte2DArrayWithInitAndIndices() {
        val a = Numkt.d2arrayIndices(2, 3) { i, j -> (i * j + 7).toByte() }
    ...
    fun createAlignedByte2DArray() {
        ...
        val a: D2Array<Byte> = Numkt.createAlignedNDArray(list, filling = 0.0)
    ...
    fun createZeroFilledShortArray() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.zeros<Short>(dim1, dim2)
    ...
    fun createShortArrayFilledWithOnes() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.ones<Short>(dim1, dim2)
    ...
    fun createTwoDimensionalArrayFromShortList() {
        ...
        val a: D2Array<Short> = Numkt.ndarray(list)
        assertEquals(list, a.toListD2())
    }
    ...
    fun createTwoDimensionalArrayFromShortSet() {
        ...
        val shape = intArrayOf(2, 3)
        val a: D2Array<Short> = Numkt.ndarray(set, shape = shape)
    ...
    fun createShort2DArrayWithInitializationFunction() {
        val a = Numkt.d2array<Short>(2, 3) { (it + 3).toShort() }
    ...
    fun createShort2DArrayWithInitAndIndices() {
        val a = Numkt.d2arrayIndices(2, 3) { i, j -> (i * j + 7).toShort() }
    ...
    fun createAlignedShort2DArray() {
        ...
        val a: D2Array<Short> = Numkt.createAlignedNDArray(list, filling = 0.0)
    ...
    fun createZeroFilledIntArray() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.zeros<Int>(dim1, dim2)
    ...
    fun createIntArrayFilledWithOnes() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.ones<Int>(dim1, dim2)
    ...
    fun createTwoDimensionalArrayFromIntList() {
        ...
        val a: D2Array<Int> = Numkt.ndarray(list)
        assertEquals(list, a.toListD2())
    }
    ...
    fun createTwoDimensionalArrayFromIntSet() {
        ...
        val shape = intArrayOf(2, 3)
        val a: D2Array<Int> = Numkt.ndarray(set, shape = shape)
    ...
    fun createInt2DArrayWithInitializationFunction() {
        val a = Numkt.d2array<Int>(2, 3) { (it + 3) }
    ...
    fun createInt2DArrayWithInitAndIndices() {
        val a = Numkt.d2arrayIndices(2, 3) { i, j -> i * j + 7 }
    ...
    fun createAlignedInt2DArray() {
        ...
        val a: D2Array<Int> = Numkt.createAlignedNDArray(list, filling = 0.0)
    ...
    fun createZeroFilledLongArray() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.zeros<Long>(dim1, dim2)
    ...
    fun createLongArrayFilledWithOnes() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.ones<Long>(dim1, dim2)
    ...
    fun createTwoDimensionalArrayFromLongList() {
        ...
        val a: D2Array<Long> = Numkt.ndarray(list)
        assertEquals(list, a.toListD2())
    }
    ...
    fun createTwoDimensionalArrayFromLongSet() {
        ...
        val shape = intArrayOf(2, 3)
        val a: D2Array<Long> = Numkt.ndarray(set, shape = shape)
    ...
    fun createLong2DArrayWithInitializationFunction() {
        val a = Numkt.d2array<Long>(2, 3) { it + 3L }
    ...
    fun createLong2DArrayWithInitAndIndices() {
        val a = Numkt.d2arrayIndices<Long>(2, 3) { i, j -> i * j + 7L }
    ...
    fun createAlignedLong2DArray() {
        ...
        val a: D2Array<Long> = Numkt.createAlignedNDArray(list, filling = 0.0)
    ...
    fun createZeroFilledFloatArray() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.zeros<Float>(dim1, dim2)
    ...
    fun createFloatArrayFilledWithOnes() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.ones<Float>(dim1, dim2)
    ...
    fun createTwoDimensionalArrayFromFloatList() {
        ...
        val a: D2Array<Float> = Numkt.ndarray(list)
        assertEquals(list, a.toListD2())
    }
    ...
    fun createTwoDimensionalArrayFromFloatSet() {
        ...
        val shape = intArrayOf(2, 3)
        val a: D2Array<Float> = Numkt.ndarray(set, shape = shape)
    ...
    fun createFloat2DArrayWithInitializationFunction() {
        val a = Numkt.d2array<Float>(2, 3) { it + 3f }
    ...
    fun createFloat2DArrayWithInitAndIndices() {
        val a = Numkt.d2arrayIndices<Float>(2, 3) { i, j -> i * j + 7f }
    ...
    fun createAlignedFloat2DArray() {
        ...
        val a: D2Array<Float> = Numkt.createAlignedNDArray(list, filling = 0.0)
        assertEquals(expected, a.toListD2())
    }
    ...
    fun createZeroFilledDoubleArray() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.zeros<Double>(dim1, dim2)
    ...
    fun createDoubleArrayFilledWithOnes() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.ones<Double>(dim1, dim2)
    ...
    fun createTwoDimensionalArrayFromDoubleList() {
        ...
        val a: D2Array<Double> = Numkt.ndarray(list)
        assertEquals(list, a.toListD2())
    }
    ...
    fun createTwoDimensionalArrayFromDoubleSet() {
        ...
        val shape = intArrayOf(2, 3)
        val a: D2Array<Double> = Numkt.ndarray(set, shape = shape)
    ...
    fun createDouble2DArrayWithInitializationFunction() {
        val a = Numkt.d2array<Double>(2, 3) { it + 3.0 }
    ...
    fun createDouble2DArrayWithInitAndIndices() {
        val a = Numkt.d2arrayIndices<Double>(2, 3) { i, j -> i * j + 7.0 }
    ...
    fun createAlignedDouble2DArray() {
        ...
        val a: D2Array<Double> = Numkt.createAlignedNDArray(list, filling = 0.0)
    ...
    fun createZeroFilledComplexFloatArray() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.zeros<ComplexFloat>(dim1, dim2)
    ...
    fun createComplexFloatArrayFilledWithOnes() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.ones<ComplexFloat>(dim1, dim2)
    ...
    fun createIdentityComplexFloatMatrix() {
        val n = 7
        val a = Numkt.identity<ComplexFloat>(n)
    ...
    fun createTwoDimensionalArrayFromComplexFloatList() {
        val list = listOf(
            listOf(ComplexFloat.one, 3f + 0f.i, 8f + 0f.i), listOf(4f + 0f.i, 7f + 0f.i, 2f + 0f.i)
        )
        val a: D2Array<ComplexFloat> = Numkt.ndarray(list)
        assertEquals(list, a.toListD2())
    }
    ...
    fun createTwoDimensionalArrayFromComplexFloatSet() {
        ...
        val shape = intArrayOf(2, 3)
        val a: D2Array<ComplexFloat> = Numkt.ndarray(set, shape = shape)
    ...
    fun createComplexFloat2DArrayWithInitializationFunction() {
        val a = Numkt.d2array<ComplexFloat>(2, 3) { ComplexFloat(it + 3.21f, round((it - .832f) * 1e5f) / 1e5f) }
        val expected = complexFloatArrayOf(
            3.21f - .832f.i, 4.21f + 0.168f.i, 5.21f + 1.168f.i, 6.21f + 2.168f.i, 7.21f + 3.168f.i, 8.21f + 4.168f.i
        )
    ...
    fun createComplexFloat2DArrayWithInitAndIndices() {
        val a = Numkt.d2arrayIndices<ComplexFloat>(2, 3) { i, j -> i * j + ComplexFloat(7) }
    ...
    fun createZeroFilledComplexDoubleArray() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.zeros<ComplexDouble>(dim1, dim2)
    ...
    fun createComplexDoubleArrayFilledWithOnes() {
        val dim1 = 5
        val dim2 = 7
        val a = Numkt.ones<ComplexDouble>(dim1, dim2)
    ...
    fun createIdentityMatrix() {
        val n = 7
        val a = Numkt.identity<ComplexDouble>(n)
    ...
    fun createTwoDimensionalArrayFromComplexDoubleList() {
        val list = listOf(listOf(1.0 + .0.i, 3.0 + .0.i, 8.0 + .0.i), listOf(4.0 + .0.i, 7.0 + .0.i, 2.0 + .0.i))
        val a: D2Array<ComplexDouble> = Numkt.ndarray(list)
        assertEquals(list, a.toListD2())
    }
    ...
    fun createTwoDimensionalArrayFromComplexDoubleSet() {
        ...
        val shape = intArrayOf(2, 3)
        val a: D2Array<ComplexDouble> = Numkt.ndarray(set, shape = shape)
    ...
    fun createComplexDouble2DArrayWithInitializationFunction() {
        val a = Numkt.d2array<ComplexDouble>(2, 3) { ComplexDouble(it + 3.21, round((it - .832) * 1e5) / 1e5) }
        val expected = complexDoubleArrayOf(3.21 - .832.i, 4.21 + 0.168.i, 5.21 + 1.168.i, 6.21 + 2.168.i, 7.21 + 3.168.i, 8.21 + 4.168.i)
    ...
    fun createComplexDouble2DArrayWithInitAndIndices() {
        val a = Numkt.d2arrayIndices<ComplexDouble>(2, 3) { i, j -> i * j + ComplexDouble(7) }
